import{j as e}from"./vendor-motion-sJhi7ExN.js";import{r as a,c as g,L as j}from"./vendor-react-CKzJvXsF.js";import{c as r,X as v,f as y,H as N,g as w,h as k,U as C}from"./index-BKOEevxj.js";import{C as S}from"./chevron-right-D8xZ5EQ2.js";import{S as L}from"./search-BtoisWjD.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=r("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const M=r("HelpCircle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $=r("LogOut",[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]]);/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=r("Settings",[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z",key:"1qme2f"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]),A=[{id:"dashboard",name:"Dashboard",icon:N,href:"/dashboard"},{id:"analytics",name:"Analytics",icon:w,href:"/analytics"},{id:"documents",name:"Documents",icon:H,href:"/documents",badge:"3"},{id:"notifications",name:"Notifications",icon:k,href:"/notifications",badge:"12"},{id:"profile",name:"Profile",icon:C,href:"/profile"},{id:"settings",name:"Settings",icon:E,href:"/settings"},{id:"help",name:"Help & Support",icon:M,href:"/help"}];function J({className:c="",children:m}){const[n,l]=a.useState(!1),[t,x]=a.useState(!1),o=g(),[u,f]=a.useState(o.pathname);a.useEffect(()=>{f(o.pathname)},[o.pathname]),a.useEffect(()=>{const s=()=>{window.innerWidth>=768?l(!0):l(!1)};return s(),window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]);const i=()=>l(!n),h=()=>x(!t),p=()=>{window.location.reload()};return e.jsxs("div",{className:"flex min-h-screen bg-background",children:[e.jsx("button",{onClick:i,className:"fixed top-6 left-6 z-50 p-3 rounded-lg bg-card shadow-card border border-border md:hidden hover:bg-muted transition-all duration-200","aria-label":"Toggle sidebar",children:n?e.jsx(v,{className:"h-5 w-5 text-muted-foreground"}):e.jsx(y,{className:"h-5 w-5 text-muted-foreground"})}),n&&e.jsx("div",{className:"fixed inset-0 bg-background/70 backdrop-blur-sm z-30 md:hidden transition-opacity duration-300",onClick:i}),e.jsxs("div",{className:`
        ...
        `,children:[e.jsx("div",{className:"md:hidden h-16"}),m]})]})}export{J as S};
