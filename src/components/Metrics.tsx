...
const MetricCard = ({ value, label, suffix, icon: Icon, accent }: MetricProps) => {
  ...
  return (
    <motion.div
      ...
      className="relative bg-white/5 backdrop-blur-md rounded-2xl p-6 md:p-8 hover:bg-white/10 hover:shadow-2xl transition-all text-center border border-white/10 hover:border-blue-400/40 overflow-hidden"
    >
    ...
    <section className="relative py-20 md:py-24 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <MetricCard value={50} suffix="+" label="Clients & Individuals" icon={Users} accent="from-blue-500 to-sky-500" />
        ...
        <ScrollReveal direction="up">
          <div className="mt-12 md:mt-16 text-center">
            ...
            <a
              href="#contact"
              className="shine-on-hover inline-block bg-gradient-to-r from-blue-600 to-blue-500 hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-0.5 text-white px-8 py-3 rounded-xl font-semibold transition-all"
            >
