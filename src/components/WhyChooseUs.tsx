          ...
          {reasons.map((item, index) => {
            ...
            return (
              ...
              >
                <MagnetCard
                  intensity={10}
                  className="h-full bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl hover:bg-white/10 hover:border-blue-400/40 hover:shadow-2xl transition-all"
                >
