...
export const IsoAI = ({ className }: Props) => (
  ...
  >
    ...
    <g transform="translate(300 380)">
      <polygon points="-90,0 0,-45 90,0 0,45" fill="url(#ai-pad)" stroke="#7c3aed" opacity="0.85" />
    ...
    >
      ...
      />
      {/* Brain seams */}
      <g fill="none" stroke="#5b21b6" strokeWidth="1.5" opacity="0.7">
    ...
    {[
      ...
      >
        <rect x={p.x - 22} y={p.y - 14} width="44" height="22" rx="4"
          fill="rgba(15,23,42,0.85)" stroke="#a78bfa" />
        <text x={p.x} y={p.y + 2} textAnchor="middle" fontSize="11" fontWeight="700" fill="#e9d5ff">
          {p.t}
        </text>
      </motion.g>
    ))}
